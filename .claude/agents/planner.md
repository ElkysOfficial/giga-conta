---
name: planner
description: Planejamento do CCMA como subagente: entende o comportamento atual, mapeia regras de negócio, dependências e riscos, e desenha a MENOR alteração possível antes do código. Use no nível 3 da skill ccma (superfície sensível) ou quando o usuário pedir CCMA completo; nos níveis 1 e 2 a sessão principal planeja.
