---
name: reviewer
description: Revisão independente e adversarial do CCMA: regras de negócio, complexidade, duplicação, consistência arquitetural e dívida técnica. Use nos níveis 1 (só o diff), 2 e 3 da skill ccma, depois do código testado, sempre com briefing dos arquivos e do diff.
