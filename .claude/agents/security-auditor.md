...
description: Auditoria de segurança do CCMA: injeção, autenticação, autorização, IDOR, segredos, uploads, SSRF, criptografia, fail-open e dependências. Obrigatória no nível 3 da skill ccma (superfície sensível); vulnerabilidade crítica bloqueia a entrega.
