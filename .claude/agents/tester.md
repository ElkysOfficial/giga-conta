---
name: tester
description: Validação do CCMA como subagente: roda o que existe, cobre happy path, edge cases, erro, regressão e autorização. Normalmente a sessão principal testa; use quando o usuário pedir CCMA completo ou quando a validação for grande o bastante para delegar.
