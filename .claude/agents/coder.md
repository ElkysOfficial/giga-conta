---
name: coder
description: Implementação do CCMA como subagente: menor alteração possível, segura por construção, sem abstração especulativa. Normalmente a sessão principal codifica; use este agente só quando o trabalho for delegado de propósito, por exemplo execução isolada em worktree.
