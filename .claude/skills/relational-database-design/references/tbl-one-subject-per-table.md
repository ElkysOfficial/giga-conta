...
Test each table by asking what single subject it is about; every field must be a characteristic of _that_ subject. If fields describe a second subject, that subject is its own table, joined by a key.
