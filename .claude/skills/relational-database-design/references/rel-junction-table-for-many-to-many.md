...
The junction table often carries fields that belong to the _association itself_ (a grade, an enrollment date, a quantity) — data that describes neither entity alone.
